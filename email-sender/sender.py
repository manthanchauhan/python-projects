...
datafile_address = '/home/manthan/Git/python-projects/email-sender/Book1.csv'
#messagefile_address = 'D:\Git\python-projects\email-sender\message.txt'
messagefile_address = '/home/manthan/Git/python-projects/email-sender/message.txt'
...
def read_data():
    ...
    contacts = list(zip(dataframe['name'], dataframe['email']))    
    return contacts
def read_msg():
